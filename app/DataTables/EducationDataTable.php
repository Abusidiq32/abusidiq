...
class EducationDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            return '
            <a href="' . route('admin.education.edit', $query->id ) . '" class="btn btn-primary"><i class="fas fa-edit"></i></a> 
    ...
    public function getColumns(): array
    {
        return [
            Column::make('id'),
            Column::make('university')->width(200),
            Column::make('field_of_study')->width(200),
            Column::make('graduation_date'),
