...
{{-- SEO overrides --}}
@section('seo_title', $blog->title . ' | ' . ($seoSettings->title ?? ''))
@section('seo_description', \Illuminate\Support\Str::limit(strip_tags($blog->excerpt ?? $blog->description), 155))
@section('canonical', route('blog.details', $blog->slug))
...
@push('head')
    <script type="application/ld+json">
        ...
        'dateModified' => optional($blog->updated_at ?? $blog->created_at)->toIso8601String(),
        'author' => ['@type' => 'Person', 'name' => 'Abubakar Abdulganiyu'],
        'image' => asset($blog->image),
        'mainEntityOfPage' => route('blog.details', $blog->slug),
        'description' => \Illuminate\Support\Str::limit(strip_tags($blog->excerpt ?? $blog->description), 160),
